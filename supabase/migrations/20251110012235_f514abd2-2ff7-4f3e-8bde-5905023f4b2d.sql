-- Update reset_daily_view_stats2 to save yesterday's data to daily_view_stats2 before deleting logs
...
BEGIN
  ...
  v_yesterday_date := (DATE_TRUNC('day', now() AT TIME ZONE 'Asia/Ho_Chi_Minh') AT TIME ZONE 'UTC' - INTERVAL '1 day')::DATE;
