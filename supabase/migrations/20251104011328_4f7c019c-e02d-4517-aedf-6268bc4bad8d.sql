-- Fix get_view2_stats to correctly return yesterday views
...
BEGIN
  ...
  -- Count NEW logs from view_logs2 (after last reset)
  ...
  -- Note: yesterday is ONLY from base stats (no logs from yesterday should exist)
  RETURN QUERY SELECT
    v_base_yesterday,  -- Yesterday is complete in base stats, don't add logs
